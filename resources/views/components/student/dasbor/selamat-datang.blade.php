...
<section class="mt-5 flex flex-wrap gap-3 text-sm tracking-wide">
    <h5 class="cursor-pointer w-fit px-5 py-2 font-medium rounded-full shadow-lg bg-[#fbecf1] border-2 border-[#f9d4e2] transition-all duration-300 ease-in-out lg:hover:bg-[#f9d4e2]">
