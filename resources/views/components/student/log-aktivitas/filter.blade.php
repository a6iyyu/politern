    ...
    <div class="flex flex-col">
        <div class="relative w-full md:w-56">
            <select name="periode" id="periode"
                class="appearance-none w-full text-[var(--secondary-text)] border border-[var(--stroke)] rounded-md px-3 py-2 text-sm focus:outline-none focus:ring-1 focus:ring-[var(--primary)]">
