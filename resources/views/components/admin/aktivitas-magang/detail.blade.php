        ...
        <div class="w-full max-w-4xl max-h-[90vh] flex flex-col bg-white rounded-xl shadow-lg border border-[var(--stroke)] overflow-hidden">
            ...
            <div class="px-7 pt-7 pb-2 flex-shrink-0">
                <div class="flex items-center justify-between mb-3">
                    ...
                    <i id="close-detail-aktivitas-admin" class="fa-solid fa-xmark cursor-pointer text-[var(--primary)] text-xl hover:text-red-500 transition-colors"></i>
                </div>
                ...
                <div class="px-7 py-4 border-b border-[var(--stroke)]">
                    <div class="flex items-center justify-between">
                        <div class="flex items-center gap-5">
                            <span class="bg-[var(--primary)] text-white text-sm font-medium px-4 py-2 rounded-full">
                                Minggu ke-<span id="minggu_log_admin">-</span>
                            </span>
                            <h3 id="judul_log_admin" class="text-lg font-semibold text-[var(--primary)]">-</h3>
                        </div>
                        <div id="status_badge_admin" class="px-4 py-2 rounded-full text-sm font-medium">
                            <span id="status_admin">-</span>
                        </div>
                    </div>
                </div>
                ...
                <div class="px-7 py-5 bg-gray-50 border-b border-[var(--stroke)]">
                    ...
                    <div class="flex items-start gap-4">
                        <div class="flex-shrink-0">
                            <img id="foto_profil_admin" src="" alt="Foto Profil" class="w-16 h-16 rounded-full object-cover border-2 border-[var(--stroke)]">
                        </div>
                        <div class="flex-1 grid grid-cols-1 md:grid-cols-2 gap-4">
                            <div class="flex flex-col">
                                <span class="text-sm text-[var(--secondary-text)] font-medium">Nama Lengkap</span>
                                <span id="nama_mahasiswa_admin" class="text-base text-[var(--primary-text)] font-semibold mt-1">-</span>
                            </div>
                            <div class="flex flex-col">
                                <span class="text-sm text-[var(--secondary-text)] font-medium">NIM</span>
                                <span id="nim_admin" class="text-base text-[var(--primary-text)] font-semibold mt-1">-</span>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="px-7 py-5">
                    ...
                    <div class="mb-6">
                        ...
                        <div class="mt-2 p-4 bg-gray-50 rounded-lg border border-[var(--stroke)]">
                            <p id="deskripsi_admin" class="text-[var(--primary-text)] leading-relaxed">-</p>
                        </div>
                    </div>
                        ...
                        <div class="mt-2">
                            ...
                            <div id="foto-container-admin" class="hidden">
                                ...
                                <div class="mt-2 text-center">
                                    <button id="foto-fullscreen-admin" class="text-sm text-[var(--primary)] hover:underline">
                    ...
                    <div class="mb-6">
                        ...
                        <div class="mt-2 p-4 bg-blue-50 rounded-lg border border-blue-200">
                            <p id="komentar_admin" class="text-[var(--primary-text)] leading-relaxed">-</p>
                        </div>
                    </div>

                    <div class="flex justify-between items-center pt-4 border-t border-[var(--stroke)]">
                        <span class="text-sm text-[var(--secondary-text)]">
                            Dikonfirmasi pada: <span id="konfirmasi_pada_admin" class="font-medium text-[var(--primary-text)]">-</span>
                        </span>
                    </div>
                </div>
            </div>
