<form action="{{ route('admin.aktivitas-magang') }}" method="GET" class="mb-7 grid grid-cols-1 gap-4 lg:grid-cols-4">
    <x-input
...
@if (isset($periode_magang) && $periode_magang->status == 'AKTIF')
