...
<a href="javascript:void(0)" data-id="{{ $lowongan->id_lowongan }}" class="btn-edit-lowongan inline-flex items-center rounded px-4 py-2 text-white text-xs font-medium bg-[var(--yellow-tertiary)] hover:bg-yellow-500 mr-1">
    Edit
</a>
