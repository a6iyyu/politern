<section class="flex items-center justify-between mb-7">
    ...
    <div class="flex items-center gap-4">
        ...
        <a href="javascript:void(0)" data-target="tambah-dosen" class="open text-sm bg-[var(--primary)] text-white px-4 py-3 rounded-md cursor-pointer hover:bg-[var(--primary)]/90 transition-colors">
            Tambah Data Dosen
        </a>
    </div>
</section>
