<div class="flex flex-col md:flex-row items-end justify-between gap-4 md:gap-6 w-full">
    ...
    <div class="flex flex-col">
        <div class="relative w-full md:w-50">
            <div class="pointer-events-none absolute inset-y-0 left-3 flex items-center text-[var(--text-secondary)]">
                <i class="fa-solid fa-chevron-down text-sm"></i>
            </div>
            <select name="bidang" id="bidang"
                class="appearance-none w-full text-[var(--text-secondary)] border border-[var(--stroke)] rounded-md pl-10 pr-3 py-2 text-sm focus:outline-none focus:ring-1 focus:ring-[var(--primary)]">
