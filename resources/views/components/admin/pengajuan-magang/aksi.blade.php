<a href="javascript:void(0)" data-id="{{ $pengajuan->id_pengajuan_magang }}" class="detail inline-flex items-center rounded px-4 py-2 text-white text-xs font-medium bg-[var(--blue-tertiary)] hover:bg-blue-700 mr-1">
    Detail
</a>
