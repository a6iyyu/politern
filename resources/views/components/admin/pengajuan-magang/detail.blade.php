<section id="modal-konfirmasi-pengajuan" class="fixed inset-0 z-50 hidden items-center justify-center bg-black/20 backdrop-blur-[1px] overflow-y-auto" aria-modal="true" role="dialog">
        ...
        <div class="w-full max-w-3xl max-h-[90vh] flex flex-col bg-white rounded-xl shadow-lg border border-[var(--stroke)] overflow-hidden">
            ...
            <div class="px-7 pt-7 pb-2 flex-shrink-0">
                <div class="flex items-center justify-between mb-3">
                    ...
                    <i id="close-konfirmasi" class="fa-solid fa-xmark cursor-pointer text-[var(--primary)] text-lg"></i>
                </div>
                ...
                <div class="px-6 py-2 flex items-start gap-8">
                    ...
                    <div class="space-y-2">
                        <div class="flex items-center gap-2 text-sm">
                            ...
                            <span id="posisi" class="text-[var(--secondary-text)]">-</span>
                        </div>
                        <div class="flex items-center gap-2 text-sm">
                ...
                <div class="px-2">
                    <div class="grid grid-cols-2 gap-y-4 gap-x-14 mt-5 text-sm">
                        ...
                        <div class="flex flex-col">
                            ...
                            <span id="nama_mahasiswa" class="text-[var(--secondary-text)]">-</span>
                        </div>
                        <div class="flex flex-col">
                        ...
                        <div class="flex flex-col">
                            ...
                            <span id="prodi" class="text-[var(--secondary-text)]">-</span>
                        </div>
                        <div class="flex flex-col">
                    ...
                    <div class="cursor-default mt-2 px-6 py-4 bg-none rounded-md border border-[var(--stroke)]">
                        <a id="cv_link" href="#" target="_blank" class="text-sm text-blue-700 underline">
                            <span id="cv_nama_file">-</span>
                        </a>
                    </div>
