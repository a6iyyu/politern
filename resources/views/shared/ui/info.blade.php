<figure class="max-w-1/2 w-full border cursor-pointer border-[var(--stroke)] bg-white pb-6 pt-4 px-6 rounded-xl transition-all duration-300 ease-in-out lg:max-w-1/3 lg:hover:bg-[#f9f9f9]">
