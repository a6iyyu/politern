<aside class="fixed pb-12 z-50 translate-x-0 left-0 top-0 h-full w-76 flex-col space-y-4 border-r-2 rounded-r-2xl border-[#6d6adc] p-6 shadow-2xl bg-[#5955b2] transition-all duration-300 ease-in-out">
    ...
    <nav class="mb-4 mt-2 flex overflow-y-scroll h-full flex-1 flex-col gap-2">
        @if (Auth::check() && Auth::user()->tipe === 'ADMIN')
            <a href="{{ route('admin.dasbor') }}" class="flex items-center font-normal pl-5 pr-7 py-3 {{ Request::is('admin') ? 'bg-white rounded-lg text-[#5955b2]' : 'text-white' }}">
            ...
            <a href="{{ route('admin.data-mahasiswa') }}" class="flex items-center font-normal pl-5 pr-7 py-3 {{ Request::is('admin/data-mahasiswa*') ? 'bg-white rounded-lg text-[#5955b2]' : 'text-white' }}">
            ...
            <a href="{{ route('admin.data-dosen') }}" class="flex items-center font-normal pl-5 pr-7 py-3 {{ Request::is('admin/data-dosen*') ? 'bg-white rounded-lg text-[#5955b2]' : 'text-white' }}">
            ...
            <a href="{{ route('admin.data-perusahaan') }}" class="flex items-center font-normal pl-5 pr-7 py-3 {{ Request::is('admin/data-perusahaan*') ? 'bg-white rounded-lg text-[#5955b2]' : 'text-white' }}">
            ...
            <a href="{{ route('admin.periode-magang') }}" class="flex items-center font-normal pl-5 pr-7 py-3 {{ Request::is('admin/periode-magang*') ? 'bg-white rounded-lg text-[#5955b2]' : 'text-white' }}">
            ...
            <a href="{{ route('admin.lowongan-magang') }}" class="flex items-center font-normal pl-5 pr-7 py-3 {{ Request::is('admin/lowongan-magang*') ? 'bg-white rounded-lg text-[#5955b2]' : 'text-white' }}">
            ...
            <a href="{{ route('admin.pengajuan-magang') }}" class="flex items-center font-normal pl-5 pr-7 py-3 {{ Request::is('admin/pengajuan-magang*') ? 'bg-white rounded-lg text-[#5955b2]' : 'text-white' }}">
            ...
            <a href="{{ route('admin.aktivitas-magang') }}" class="flex items-center font-normal pl-5 pr-7 py-3 {{ Request::is('admin/aktivitas-magang*') ? 'bg-white rounded-lg text-[#5955b2]' : 'text-white' }}">
        ...
        @if (Auth::check() && Auth::user()->tipe === 'MAHASISWA')
            <a href="{{ route('mahasiswa.dasbor') }}" class="flex items-center font-normal pl-5 pr-7 py-3 {{ Request::is('mahasiswa') ? 'bg-white rounded-lg text-[#5955b2]' : 'text-white/50' }}">
                <img src="{{ Request::is('mahasiswa') ? asset('icons/dasbor-biru.svg') : asset('icons/dasbor-putih.svg') }}" alt="Dasbor" class="h-5 w-5" />
                <h4 class="ml-7 text-sm tracking-wider">Dasbor</h4>
            </a>
            <a href="{{ route('mahasiswa.lowongan') }}" class="flex items-center font-normal pl-5 pr-7 py-3 {{ Request::is('mahasiswa/lowongan*') ? 'bg-white rounded-lg text-[#5955b2]' : 'text-white/50' }}">
            ...
            <a href="{{ route('mahasiswa.kelola-lamaran') }}" class="flex items-center font-normal pl-5 pr-7 py-3 {{ Request::is('mahasiswa/kelola-lamaran*') ? 'bg-white rounded-lg text-[#5955b2]' : 'text-white/50' }}">
            ...
            <a href="{{ route('mahasiswa.log-aktivitas') }}" class="flex items-center font-normal pl-5 pr-7 py-3 {{ Request::is('mahasiswa/log-aktivitas*') ? 'bg-white rounded-lg text-[#5955b2]' : 'text-white/50' }}">
