...
class RekomendasiMagang extends Controller
{
    /**
     * @param int $id
     * @return array{lowongan: TModel|Collection, skor: float[]}
     */
    public function index(int $id): array
    {
        ...
        if (empty($matriks_alternatif)) return ['lowongan' => collect(), 'skor' => []];
        ...
        return [
            ...
            'id' => $id,
            // Data debug untuk tampilan matriks
            'debug' => [
                'lowongan_data' => $lowongan_magang,
                'matriks_alternatif' => $matriks_alternatif,
                'matriks_normalisasi' => $matriks_normalisasi,
                'bobot' => $bobot,
                'matriks_terbobot' => $matriks_terbobot,
    ...
    // Method terpisah untuk menampilkan debug TOPSIS
...
// try {
//     $result = $this->index($id);
//     return view('student.dasbor.table', compact('result'));
// } catch (\Exception $e) {
